      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition ${
              selectedCategory === null
                ...
                : "bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 hover:border-primary-yellow dark:hover:bg-gray-700 text-gray-900 dark:text-white shadow-md"
            }`}
          >
            Todos
          </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {filteredProducts.map((product) => (
            <div
              key={product.id}
              className="bg-white dark:bg-gray-900 rounded-lg overflow-hidden hover:scale-105 transition-transform border border-gray-200 dark:border-gray-700 shadow-lg"
            >
